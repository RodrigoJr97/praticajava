...
public class Disciplina {
	...
	public Disciplina(String disciplina1, double nota1, String disciplina2, double nota2, String disciplina3,
			double nota3, String disciplina4, double nota4) {
		super();
	...
	public String toString() {
		...
		+ "\nDisciplina: " + getDisciplina2()	+ ", Nota = " + getNota2() 
		+ "\nDisciplina: " + getDisciplina3() + ", Nota = " + getNota3() 
		+ "\nDisciplina: "+ getDisciplina4() + ", Nota = " + getNota4()
		+ "\n---------------------------------------------";
	}
